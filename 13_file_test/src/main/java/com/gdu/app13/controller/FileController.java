...
public class FileController {
  ...
  private final FileService fileService;  // FileService를 주입받는 생성자 주입을 위한 필드
  ...
  public String upload(MultipartHttpServletRequest multipartRequest, RedirectAttributes redirectAttributes) {
    ...
    redirectAttributes.addFlashAttribute("addResult", addResult); // 업로드 결과를 Flash 속성으로 추가
    return "redirect:/main.do";  // 업로드 후에 메인 페이지로 리다이렉트
  }
