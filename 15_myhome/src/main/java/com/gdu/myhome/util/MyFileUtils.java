...
public class MyFileUtils {
  ...
  public String getBlogImagePath() {
    ...
    return "user/seoga-eul/blog/" + DateTimeFormatter.ofPattern("yyyy/MM/dd").format(today);
  }
  
  // 업로드 게시판 작성시 첨부한 파일이 저장될 경로 반환하기
  public String getUploadPath() {
    LocalDate today = LocalDate.now();
    return "user/seoga-eul/upload/" + DateTimeFormatter.ofPattern("yyyy/MM/dd").format(today);
  }
  ...
  public String getBlogImagePathInYesterday() {
    ...
    return "user/seoga-eul/blog/" + DateTimeFormatter.ofPattern("yyyy/MM/dd").format(date);
  }
