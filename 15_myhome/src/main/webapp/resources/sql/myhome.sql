...
CREATE TABLE FREE_T (
    ...
    STATUS          NUMBER              NOT NULL, -- 1: 정상, 0: 삭제된 게시글
    DEPTH           NUMBER              NOT NULL, -- 0: 원글, 1: 댓글, 2: 대댓글, ...
    GROUP_NO        NUMBER              NOT NULL, -- 원글과 모든 댓글(댓글, 대댓글)은 동일한 GROUP_NO를 가져야한다
...
CREATE TABLE BLOG_T (
    ...
    USER_NO     NUMBER              NOT NULL,   -- 작성자 번호
    ...
    CONSTRAINT FK_USER_BLOG FOREIGN KEY(USER_NO) REFERENCES USER_T(USER_NO) ON DELETE CASCADE
);
...
INSERT INTO FREE_T VALUES (FREE_SEQ.NEXTVAL, 'user1@naver.com', '내용13', SYSTIMESTAMP, 1, 0, FREE_SEQ.CURRVAL, 0);
